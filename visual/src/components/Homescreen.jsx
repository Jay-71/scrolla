  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <Link to="/roadmap" className="hidden md:block px-6 py-2 border border-steel-300 rounded text-xs font-semibold uppercase tracking-[0.1em] text-steel-800 hover:border-steel-600 hover:text-steel-950 transition-all duration-300 bg-white/50">
          View Roadmap
        </Link>
      </div>
    </header>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 w-full">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              <Link to="/roadmap" className="btn-premium px-10 py-5 text-steel-900 font-semibold uppercase tracking-[0.1em] text-sm flex items-center justify-center gap-3 group shadow-xl">
                Explore Roadmap
...
export default function Homescreen() {
  return (
    <main className="min-h-screen text-steel-900 bg-[#f8f9fa] selection:bg-steel-200 selection:text-steel-950 relative font-sans">
      <Header />
      <Hero />
      <FeaturesBento />
      <Footer />
